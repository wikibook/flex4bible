...
public class _Super_Contact extends EventDispatcher implements IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void 
    {
        try 
        {
            if (flash.net.getClassByAlias("flex4bible.chapter28.Contact") == null)
            {
                flash.net.registerClassAlias("flex4bible.chapter28.Contact", cz);
            } 
        }
        catch (e:Error) 
        {
	 ...
	 * properties
	 */
	private var _internal_contactId : Number = 0;
    ...
    {    	
    	...
    	var oldValue:Number = _internal_contactId;               
        if (oldValue !== value)
        {
        	_internal_contactId = value;
        	this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "contactId", oldValue, _internal_contactId));
        }    	     
